...
st.set_page_config(
    page_title="🤖 AIbox - Автономный Агент",
    page_icon="🤖",
    layout="wide",
...
def show_overview(agent_status):
    ...
    if resources:
        ...
        with col3:
            st.metric("GPU VRAM", resources['gpu_info'])
...
def main():
    ...
    with st.sidebar:
        ...
        if resources:
            ...
            st.write(f"GPU: {resources['gpu_info']}")
    
    # Основные вкладки
    tab1, tab2, tab3, tab4, tab5 = st.tabs([
        "📊 Обзор", "💬 Чат", "🔧 Ollama", "💾 Память", "🧠 Сознание"
    ])
